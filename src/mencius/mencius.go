...
var maccrep genericsmr.Message

func (r *Replica) replyAccept(replicaId int32, reply *menciusproto.AcceptReply) {
	//r.SendMsg(replicaId, r.acceptReplyRPC, reply)
	maccrep.PeerId = replicaId
	maccrep.Code = r.acceptReplyRPC
	maccrep.Msg = reply
	r.MessageChan <- maccrep
}
